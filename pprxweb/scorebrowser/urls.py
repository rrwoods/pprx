...
urlpatterns = [
	...
	path('manage_golden_league/<event_id>', views.manage_golden_league, name='manage_golden_league'),
	path('move_golden_league_song', views.move_golden_league_song, name='move_golden_league_song'),
	path('new_golden_league_song', views.new_golden_league_song, name='new_golden_league_song'),

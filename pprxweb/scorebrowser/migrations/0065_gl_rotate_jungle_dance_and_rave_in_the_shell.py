...
def forward(apps, schema_editor):
	...
	# two rotations because i missed one apparently.
	rotate("Jungle Dance", "Ability", "Go To The Oasis", "Teleportation")
	rotate("Rave in the Shell", "SURVIVAL AT THE END OF THE UNIVERSE", "TAKE ME HIGHER", "Environ [De-SYNC] (feat. lythe)")
...
class Migration(migrations.Migration):
	dependencies = [('scorebrowser', '0064_extra_savior_kac_2023')]
